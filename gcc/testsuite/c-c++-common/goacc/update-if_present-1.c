...
/* { dg-final { scan-tree-dump-times "omp target oacc_update if_present if.D.1873. async.10. map.from:a .len: 4.. map.to:b .len: 4.. map.from:c .len: 40.." 1 "omplower" } } */
...
/* { dg-final { scan-tree-dump-times "omp target oacc_update if.D.1875. async.10. map.force_from:a .len: 4.. map.force_to:b .len: 4.. map.force_from:c .len: 40.." 1 "omplower" } } */
