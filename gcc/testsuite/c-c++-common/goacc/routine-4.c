...
#pragma acc loop gang reduction (+:red) /* { dg-warning "gang reduction on an orphan loop" } */
  for (int i = 0; i < 10; i++)
    red ++;
...
/* { dg-warning "gang reduction on an orphan loop" "" { target *-*-* } 25 } */
/* { dg-warning "gang reduction on an orphan loop" "" { target *-*-* } 51 } */
/* { dg-warning "gang reduction on an orphan loop" "" { target *-*-* } 77 } */
